export default function AboutSection() {
  return (
    <section id="about" className="about-section" style={{ background: '#F5F0E8', padding: '80px 40px', position: 'relative', overflow: 'hidden' }}>
      <p className="section-label" style={{ marginBottom: 40, position: 'relative', zIndex: 1 }}>
        // ABOUT ME
      </p>

      {/* Two columns */}
      <div className="about-two-col" style={{ display: 'flex', gap: 48, alignItems: 'flex-start', position: 'relative', zIndex: 1 }}>
        {/* Left */}
        <div className="about-left-col" style={{ flex: 1, maxWidth: 540 }}>
          <h2 className="about-heading" style={{ fontFamily: "'DM Serif Display'", fontSize: 40, color: '#2C1F0E', lineHeight: 1.1, margin: 0 }}>
            Hi, I'm AyUsh!
          </h2>
        ...
        {/* Right — Photo */}
        <div className="about-right-col" style={{ position: 'relative', flexShrink: 0, marginLeft: 'auto', paddingRight: 10 }}>
          <img
            src="/botanical-red.png"
            alt=""
            className="botanical-red"
            style={{
              position: 'absolute',
              top: -72,
              right: -20,
      ...
      <div style={{ marginTop: 64, position: 'relative', zIndex: 1 }}>
        ...
        <div className="art-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 16 }}>
          {[
            ...
            <div key={item.caption}>
              ...
              <p className="art-caption" style={{ fontFamily: "'IBM Plex Mono'", fontSize: 10, color: '#9C8B6E', marginTop: 8 }}>{item.caption}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      {/* Photos row */}
      <div className="photos-row" style={{ marginTop: 40, display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 12, position: 'relative', zIndex: 1 }}>
