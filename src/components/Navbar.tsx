...
const RESUME_HREF =
  'https://drive.google.com/file/d/1fhWi5B_ZcUODWnDn_jTUvqqhfj_Rj2nR/view?usp=sharing';
  ...
  return (
    ...
    >
      ...
      <div className="nav-center" style={{ display: 'flex', gap: 32 }}>
        {[['WORK', '#work'], ['ABOUT', '#about'], ['RESUME', RESUME_HREF]].map(([label, href]) => (
          <a
            key={label}
            href={href}
      ...
      {/* Right */}
      <div className="nav-right" style={{ display: 'flex', gap: 20, alignItems: 'center' }}>
        <a href="https://www.linkedin.com/in/ayushsomwanshi/" target="_blank" rel="noopener noreferrer">
          <svg
            ...
            onMouseEnter={e => (e.currentTarget.style.stroke = '#2C1F0E')}
            onMouseLeave={e => (e.currentTarget.style.stroke = '#9C8B6E')}
          >
